...
a brief description. Check out the documentation for each script for more
information and examples on how to use them.

| Script                            | Description                                                                       |               Documentation               |
| :-------------------------------- | :-------------------------------------------------------------------------------- | :---------------------------------------: |
| `tp.user.createNoteWithPrompting` | Create a new note from template in a specified location with automated prompting. | [link](./docs/createNoteWithPrompting.md) |
